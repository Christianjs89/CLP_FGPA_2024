...
# CLK source 50 MHz
set_property -dict { PACKAGE_PIN H16    IOSTANDARD LVCMOS33 } [get_ports { clk_i }]; # clk_pin reemplazado por clk_i = uart_top_vio
...
# UART
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { rxd_i }]; #IO_L17P_T2_34 Sch=JA1_P
